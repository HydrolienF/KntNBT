...
public class MCAFile implements Iterable<Chunk> {
	...
	public StringTag getBiomeAt(int blockX, int blockY, int blockZ) {
		...
		return chunk.getBiomeAt(blockX % 16,blockY, blockZ % 16);
	}
	...
	public void setBlockStateAt(int blockX, int blockY, int blockZ, CompoundTag state) {
		createChunkIfMissing(blockX, blockZ).setBlockStateAt(blockX, blockY, blockZ, state);
	}
	...
	public CompoundTag getBlockStateAt(int blockX, int blockY, int blockZ) {
		...
		return chunk.getBlockStateAt(blockX % 16, blockY, blockZ % 16);
	}
